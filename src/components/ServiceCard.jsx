...
function ServiceCard({textOne, textTwo, image, variant}) {
    ...
    if(variant == "white"){
        return (
            <div className='flex justify-between py-10 pl-12 w-[650px] mx-10 border-black border-4 border-b-10 rounded-3xl'>
    ...
    return (
        <div className='flex justify-between bg-black py-10 pl-12 w-[650px] mx-10 border-black border-4 border-b-10 rounded-3xl'>
            <div className='flex flex-col justify-between h-48'>
                <div className='flex flex-col'>
